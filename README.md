...
which in quantum mechanics can be connected with the Bell State (Quantum Entanglement), , that can be mathematically represented by the formula $\mathbf{\mathbf{}{\color{Green} |\Phi^+\rangle = \frac{1}{\sqrt{2}}(|00\rangle + |11\rangle)}}$$
